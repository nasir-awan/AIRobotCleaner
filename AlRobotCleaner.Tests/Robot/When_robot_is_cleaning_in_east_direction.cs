...
{
    public class When_robot_is_cleaning_in_east_direction : When_initiazing_a_robot
    {
        private static ILocation _location;
        private static int _numberOfSteps;
        private const Direction RobotDirection = Direction.East;
        ...
        private Establish _context = () =>
        {
            ...
            _location = new Domain.Location(XCoordinate + _numberOfSteps, YCoordinate);
            Setup();
        };
